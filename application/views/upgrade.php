...
<article class="card">
	<div class="container">
        ...
        ?>
		<div class="card-body">
            <form method="post" action="<?= base_url('upgrade/package') ?>">
			<div class="payment-type">
				...
				<div class="types flex justify-space-between">
                    ...
                    ?>
					<!-- <div class="type selected" data-month="3">
						<div class="logo">
                        <i class="fas fa-ad"></i>
						</div>
						<div class="text">
...
<script>
    $(document).ready( function(){
        let startDate = "<?= date('Y-m-d H:i:s') ?>";
        let endDate = "<?=  date('Y-m-d H:i:s', strtotime("+3 months", strtotime(date('Y-m-d H:i:s')))) ?>"
    ...
    $(".type").click(function(){
        ...
        $('#circle').val(month);
        if(month == 1){
            endDate = "<?=  date('Y-m-d H:i:s', strtotime("+1 months", strtotime(date('Y-m-d H:i:s')))) ?>"
        }
        if(month == 3){
            endDate = "<?=  date('Y-m-d H:i:s', strtotime("+3 months", strtotime(date('Y-m-d H:i:s')))) ?>"
        }
        if(month == 6){
            endDate = "<?=  date('Y-m-d H:i:s', strtotime("+6 months", strtotime(date('Y-m-d H:i:s')))) ?>"
        }
        $('#endDate').val(endDate);
        $('#end_date').val(endDate);
    });
